...
import { TalosCheckboxDirective, CheckboxSize, CheckboxVariant } from './checkbox.directive';

@Component({
  imports: [TalosCheckboxDirective, ReactiveFormsModule],
  template: `
    <input
      id="test-checkbox"
      type="checkbox"
...
describe('TalosCheckboxDirective Suite', () => {
  ...
  it('should apply base talos-checkbox class', () => {
    const checkboxEl = fixture.nativeElement.querySelector('#test-checkbox') as HTMLInputElement;
    expect(checkboxEl.classList.contains('talos-checkbox')).toBe(true);
  });
  ...
  it('should apply color variant classes dynamically', () => {
    ...
    expect(checkboxEl.classList.contains('talos-checkbox-primary')).toBe(true);

    hostComponent.checkboxVariant.set('secondary');
    fixture.detectChanges();
    expect(checkboxEl.classList.contains('talos-checkbox-secondary')).toBe(true);

    hostComponent.checkboxVariant.set('success');
    fixture.detectChanges();
    expect(checkboxEl.classList.contains('talos-checkbox-success')).toBe(true);

    hostComponent.checkboxVariant.set('danger');
    fixture.detectChanges();
    expect(checkboxEl.classList.contains('talos-checkbox-danger')).toBe(true);
  });
