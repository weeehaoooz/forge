...
@Directive({
  selector: 'button[talosButtonGroupItem], a[talosButtonGroupItem], [talos-button-group-item]',
  host: {
    'class': 'talos-button-group-item',
    '[class.is-selected]': 'selected()',
    '[class.is-active]': 'selected()',
    '[attr.aria-pressed]': 'selected() ? "true" : "false"'
  }
})
export class TalosButtonGroupItemDirective {
