...
import { TalosCategoryBarComponent } from './category-bar.component';
import { CategoryBarSegment } from './category-bar.types';

describe('TalosCategoryBarComponent', () => {
  let component: TalosCategoryBarComponent;
  let fixture: ComponentFixture<TalosCategoryBarComponent>;
  ...
  beforeEach(async () => {
    ...
    fixture = TestBed.createComponent(TalosCategoryBarComponent);
  ...
  it('should render title and subtitle when provided', async () => {
    ...
    const titleEl = fixture.nativeElement.querySelector('.talos-category-bar-title');
    const subtitleEl = fixture.nativeElement.querySelector('.talos-category-bar-subtitle');
  ...
  it('should calculate segment percentages correctly based on values array', async () => {
    ...
    const segments = fixture.nativeElement.querySelectorAll('.talos-category-bar-segment');
  ...
  it('should render cumulative scale boundary labels', async () => {
    ...
    const ticks = fixture.nativeElement.querySelectorAll('.talos-category-bar-label-tick');
  ...
  it('should place marker needle at the correct percentage position', async () => {
    ...
    const markerEl = fixture.nativeElement.querySelector('.talos-category-bar-marker');
