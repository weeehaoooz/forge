...
export class TalosAutocompleteComponent<T = unknown> implements ControlValueAccessor {
  ...
  private readonly autoId = `talos-autocomplete-${uniqueAutocompleteIdCounter++}`;
