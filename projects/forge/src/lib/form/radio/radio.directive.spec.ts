...
@Component({
  imports: [ForgeRadioDirective, ReactiveFormsModule],
  template: `
    <input
      id="test-radio"
      type="radio"
...
describe('ForgeRadioDirective Suite', () => {
  ...
  it('should apply base forge-radio class', () => {
    const radioEl = fixture.nativeElement.querySelector('#test-radio') as HTMLInputElement;
    expect(radioEl.classList.contains('forge-radio')).toBe(true);
  });
  ...
  it('should apply color variant classes dynamically', () => {
    ...
    expect(radioEl.classList.contains('forge-radio-primary')).toBe(true);

    hostComponent.radioVariant.set('secondary');
    fixture.detectChanges();
    expect(radioEl.classList.contains('forge-radio-secondary')).toBe(true);

    hostComponent.radioVariant.set('success');
    fixture.detectChanges();
    expect(radioEl.classList.contains('forge-radio-success')).toBe(true);

    hostComponent.radioVariant.set('danger');
    fixture.detectChanges();
    expect(radioEl.classList.contains('forge-radio-danger')).toBe(true);
  });
