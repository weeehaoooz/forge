...
import { ForgeRadioGroupComponent, RadioDirection } from './radio-group.component';
import { ForgeRadioComponent } from './radio.component';
import { RadioSize, RadioVariant } from './radio.directive';

@Component({
  imports: [ForgeRadioGroupComponent, ForgeRadioComponent, ReactiveFormsModule],
  template: `
    <forge-radio-group
      [formControl]="control"
      [size]="groupSize()"
    ...
    >
      <forge-radio id="radio-opt-1" value="opt1">Option 1</forge-radio>
      <forge-radio id="radio-opt-2" value="opt2">Option 2</forge-radio>
      <forge-radio id="radio-opt-3" value="opt3" [disabled]="true">Option 3 (Disabled)</forge-radio>
    </forge-radio-group>
  `
})
...
describe('ForgeRadioGroupComponent Suite', () => {
  ...
  it('should render group with radiogroup role and default direction', () => {
    const groupEl = fixture.nativeElement.querySelector('forge-radio-group') as HTMLElement;
