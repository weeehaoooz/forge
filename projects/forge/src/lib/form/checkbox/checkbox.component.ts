...
import { CheckboxSize, CheckboxVariant, ForgeCheckboxDirective } from './checkbox.directive';
...
@Component({
  ...
  imports: [ForgeCheckboxDirective],
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => ForgeCheckboxComponent),
      multi: true
    }
  ],
  host: {
    'class': 'forge-checkbox-host'
  },
  template: `
    <label class="forge-checkbox-wrapper" [class.is-disabled]="effectiveDisabled()">
      <input
        #inputEl
        type="checkbox"
        forgeCheckbox
      ...
      />
      <span class="forge-checkbox-label">
        <ng-content></ng-content>
      </span>
    </label>
  `
})
export class ForgeCheckboxComponent implements ControlValueAccessor {
