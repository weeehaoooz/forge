...
import { ForgeCheckboxModule } from './checkbox.module';

@Component({
  imports: [ForgeCheckboxModule, ReactiveFormsModule],
  template: `
    <div forgeCheckboxGroup [formControl]="fruitControl" #fruitGroup="forgeCheckboxGroup">
      <input
      ...
      <input id="apple-chk" type="checkbox" forgeCheckbox value="apple" />
      <input id="banana-chk" type="checkbox" forgeCheckbox value="banana" />
      <input id="cherry-chk" type="checkbox" forgeCheckbox value="cherry" />
    </div>

    <forge-checkbox-group [formControl]="componentGroupControl">
      <forge-checkbox value="option1">Option 1</forge-checkbox>
      <forge-checkbox value="option2">Option 2</forge-checkbox>
...
describe('Forge Checkbox Group & Parent Directives Suite', () => {
  ...
  it('should work with ForgeCheckboxComponent and ForgeCheckboxGroupComponent', () => {
    expect(hostComponent.componentGroupControl.value).toEqual(['option1']);

    const checkboxes = fixture.nativeElement.querySelectorAll('forge-checkbox input[type="checkbox"]');
