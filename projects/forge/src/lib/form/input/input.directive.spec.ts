...
import { ForgeInputDirective, InputSize } from './input.directive';

@Component({
  imports: [ForgeInputDirective, ReactiveFormsModule],
  template: `
    <input
      id="test-input"
      forgeInput
...
describe('ForgeInputDirective Suite', () => {
  ...
  it('should apply base forge-input class to input and textarea', () => {
    ...
    expect(inputEl.classList.contains('forge-input')).toBe(true);
    expect(textareaEl.classList.contains('forge-input')).toBe(true);
  });
