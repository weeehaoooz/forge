...
@Component({
  selector: 'forge-range-input, forge-range-slider, forge-slider',
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => ForgeRangeInputComponent),
      multi: true
    }
  ],
  ...
  host: {
    'class': 'forge-range-input-host',
    '[class.forge-range-disabled]': 'effectiveDisabled()',
    '[class.forge-range-invalid]': 'effectiveInvalid()'
  }
})
export class ForgeRangeInputComponent implements ControlValueAccessor {
  ...
  private readonly defaultId = `forge-range-${++rangeInputCounter}`;
