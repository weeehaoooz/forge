...
@Component({
  selector: 'forge-button-group',
  template: `<ng-content></ng-content>`,
  host: {
    'class': 'forge-button-group',
    '[class.forge-button-group-horizontal]': 'orientation() === "horizontal"',
    '[class.forge-button-group-vertical]': 'orientation() === "vertical"',
    '[class.forge-button-group-attached]': 'variant() === "attached"',
    '[class.forge-button-group-segmented]': 'variant() === "segmented"',
    '[class.forge-button-group-outline]': 'variant() === "outline"',
    '[class.forge-button-group-subtle]': 'variant() === "subtle"',
    '[class.forge-button-group-pill]': 'pill() || variant() === "pill"',
    '[class.forge-button-group-sm]': 'size() === "sm"',
    '[class.forge-button-group-md]': 'size() === "md"',
    '[class.forge-button-group-lg]': 'size() === "lg"',
...
export class ForgeButtonGroupComponent {
  ...
  /** Child items using ForgeButtonGroupItemDirective */
  readonly items = contentChildren(ForgeButtonGroupItemDirective, { descendants: true });

  /** Child directives using ForgeButtonDirective */
  readonly buttons = contentChildren(ForgeButtonDirective, { descendants: true });
  ...
  onClick(event: MouseEvent): void {
    ...
    let matchedItem: ForgeButtonGroupItemDirective | undefined = undefined;
