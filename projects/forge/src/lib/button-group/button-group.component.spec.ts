...
@Component({
  ...
  template: `
    <forge-button-group
      ...
      [(value)]="selectedValue"
    >
      <button forgeButton forgeButtonGroupItem [value]="'grid'" tooltip="Grid View">Grid</button>
      <button forgeButton forgeButtonGroupItem [value]="'feed'" tooltip="Feed View">Feed</button>
      <button forgeButton forgeButtonGroupItem [value]="'stack'" tooltip="Stack View">Stack</button>
    </forge-button-group>
  `
})
...
describe('ForgeButtonGroupComponent', () => {
  ...
  beforeEach(async () => {
    ...
    groupEl = fixture.nativeElement.querySelector('forge-button-group');
  ...
  it('should apply correct base host classes and default orientation', () => {
    expect(groupEl.classList.contains('forge-button-group')).toBe(true);
    expect(groupEl.classList.contains('forge-button-group-horizontal')).toBe(true);
    expect(groupEl.classList.contains('forge-button-group-attached')).toBe(true);
  ...
  it('should update classes when orientation changes to vertical', () => {
    ...
    expect(groupEl.classList.contains('forge-button-group-vertical')).toBe(true);
    expect(groupEl.classList.contains('forge-button-group-horizontal')).toBe(false);
  ...
  it('should update classes when variant changes', () => {
    ...
    expect(groupEl.classList.contains('forge-button-group-segmented')).toBe(true);
  });
